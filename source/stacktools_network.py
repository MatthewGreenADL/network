...
#        tree = rootfile.data_NoSys
    if("Random weighted" in legendentry):
        print("Random weighted in legendentry")
        tree = rootfile.network_tree_small
    if("Toy unweighted" in legendentry):
        print("Toy unweighted in legendentry")
        tree = rootfile.network_tree_toydata3
